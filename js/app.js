    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                } else if (document.querySelector(".menu").contains(e.target)) document.querySelectorAll(".menu__link").forEach((el => {
                    if (e.target.closest(".menu__link") === el) {
        ...
        function initSliders() {
            if (document.querySelector(".what__slider")) new core(".what__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".what__arrow-left",
                    nextEl: ".what__arrow-right"
                },
                on: {}
            });
        }
        ...
        new fullpage("#fullpage", {
            ...
            scrollOverflow: true,
            anchors: [ "mavic", "what", "benefits", "info", "questions", "contacts" ],
            menu: "#myMenu"
        });
        window["FLS"] = true;
        isWebp();
